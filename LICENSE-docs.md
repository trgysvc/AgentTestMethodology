...
Applies to: `METHODOLOGY_TR.md` (and its future English counterpart, `METHODOLOGY.md`), `README.md`, `CHANGELOG.md`, `STORY.md`, and any standalone article/report derived from them — the test methodology, benchmark landscape survey, protocol descriptions, and the calibration/inter-rater/minimum-k procedures and bibliography contained within.
