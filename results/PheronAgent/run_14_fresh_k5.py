...
RESULTS = "/Users/<user>/Developer/PheronAgent/Tests/AgentTestSuite/results/results_14_fresh_k5.jsonl"
LOG = "/Users/<user>/Developer/PheronAgent/Tests/AgentTestSuite/results/run_14_fresh_k5.log"
...
TESTS = [
    ...
    # v47: prompt corrected to match the doc's 2026-07 revision — the old prompt tested a
    # capability (searching an "old email archive") that emailSendLegacy never implemented.
    ("EK-TOOL-21", "'Proje Son Durumu' konulu bir e-postayı Ahmet'e gönder (legacy email client ile)", None),
